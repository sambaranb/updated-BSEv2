...
****
*      REAL*8 fmrg
*      PARAMETER (fmrg=0.5D0)
****
      REAL*8 ALPHA1,LAMBDA,ftzacc
...
*       massive (when similarly evolved).
      IF(KS(1).GT.KS(2))THEN
          I1 = 1
          I2 = 2
      ELSEIF((KS(1).EQ.KS(2)).AND.(M(1).GE.M(2)))THEN
          I1 = 1
          I2 = 2
      ELSE
          I1 = 2
...
*       Specify total mass.
      ...
      AGE3 = 0.d0
*
*       Enforce mass loss in a star-star merger process.
